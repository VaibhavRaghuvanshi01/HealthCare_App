...
//        if you want to fetch the data then use getReadalbledatabase
//        in getwritabledatabase we insert the values in table
...
//moveTofirst() will check if there is a record then returns 1
        if(c.moveToFirst()){
            result=1;
        }
        return result;
